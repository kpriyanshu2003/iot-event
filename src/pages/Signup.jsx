    ...
    <div>
      <div className="mt-24 flex justify-evenly items-center font-raleway">
        <div className="hidden md:block">
          <span className="font-semibold text-2xl">Let's</span>
          <br />
          <span className="font-bold text-3xl">Secure your login process</span>
          <br />
          <img src={credential} alt="Login Icon" className="mt-8" />
        </div>
        ...
        <div className="mx-12 w-96">
          <div className="md:absolute md:top-24">
            <div>
              ...
              <span className="font-semibold text-2xl">Sign Up to Vep</span>
              <br />
              <br />
            ...
            <div className="mt-7 md:min-w-[25rem]">
              ...
              <Link
                to="/success"
                className="mt-10 flex items-center cursor-pointer bg-[#BF13BF] rounded-2xl "
              >
                <span className="uppercase py-4 w-full border text-center font-medium text-white">
                  Next
                </span>
                <svg
                  width="20"
