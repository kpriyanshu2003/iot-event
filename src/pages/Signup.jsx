  ...
  return (
    <div>
      <div class="app-container-signup">
        <div class="img-container-signup">
          <span class="left-text-signup">Let's</span>
          <br />
        ...
        <div class="sign-up-block-2">
          <div class="responsive-sign-up-block">
            <div>
              <img src={logo} alt="Logo" class="sign-up-logo" />
              <span class="sign-up-text">Sign Up to Vep</span>
              <br />
              <br />
