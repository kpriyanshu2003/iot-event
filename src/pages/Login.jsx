  ...
  return (
    <div class="app-container-login">
      <div class="img-container-login">
        <span class="left-text">Hey!</span>
        <br />
        <span class="left-text-2">Welcome back.</span>
        <br />
        <img src={img} alt="Login Icon" class="login-icon" />
      </div>
      ...
      <div class="seven">
        <div class="right-container-login">
          ...
          <div class="input-container-login">
            ...
            <div class="flex items-center rounded-2xl mt-5 font-normal bg-[#F2F2F2]">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
